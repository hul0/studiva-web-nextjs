...
const FinalCTA = () => {
    ...
    useGSAP(() => {
        ...
        const btn = document.querySelector('#final-cta-btn');
        if (btn) {
        ...
        <section className="final-cta" id="download" ref={sectionRef}>
            <div className="container final-cta__inner">
                <div className="final-cta__content">
                    ...
                    <div className="cta-animate" style={{ marginTop: '12px', display: 'flex' }}>
                        <a
                            href="https://play.google.com/store/apps/details?id=com.studiva.app"
                            className="uiverse-download-btn"
                            id="final-cta-btn"
                            target="_blank"
                ...
                <div className="final-cta__graphic cta-animate">
                    <img
                        src="/images/funny_guy_light.png"
                        alt="Funny guy sipping from cup illustration"
                        className="dino-image dino-image--light"
                        draggable="false"
                        loading="lazy"
                    />
                    <img
                        src="/images/funny_guy_dark.png"
                        alt="Funny guy sipping from cup illustration dark mode"
                        className="dino-image dino-image--dark"
                        draggable="false"
                        loading="lazy"
                    />
                </div>
