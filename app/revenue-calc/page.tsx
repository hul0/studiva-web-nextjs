...
export default function RevenueCalcPage() {
    ...
    useEffect(() => {
        ...
        const salePrice = 1;
        const convRate = 0.1;
        const valuePerViewer = (salePrice * convRate) + (adRev * (1 - convRate));
                ...
                <div className="rev-grid">
                    <div className="rev-card rev-inputs">
                        ...
                        <div className="rev-info-box">
                            <TrendingUp size={16} />
                            <p>Based on average ad revenue and student purchase patterns on Studiva.</p>
                        </div>
                    </div>
                    ...
                    <div className="rev-card rev-results">
                        ...
                        <div className="perks-list">
                            ...
                            <div className="perk-item">
                                <div className="perk-dot"></div>
                                <span>Direct Student Payments</span>
                            </div>
                        </div>
