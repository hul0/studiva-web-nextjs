...
const engineering = [
    { name: 'Rudra Narayan Chatterjee', role: 'Web Developer', tag: 'Web Dev', seed: 'Jack' },
    { name: 'Ayush Burman', role: 'Full Stack Engineer', tag: 'Full Stack', seed: 'Jack' },
    { name: 'Debargha Sarkar', role: 'Backend Engineer', tag: 'Backend Dev', seed: 'Jack' },
];
